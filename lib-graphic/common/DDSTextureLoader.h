...
HRESULT __cdecl CreateDDSTextureFromMemory(
	...
	_In_ size_t maxsize = 0, _Out_opt_ DDS_ALPHA_MODE *alphaMode = nullptr) noexcept;
...
HRESULT __cdecl CreateDDSTextureFromMemoryEx(
	_In_ ID3D11Device *d3dDevice, _In_reads_bytes_(ddsDataSize) const uint8_t *ddsData,
