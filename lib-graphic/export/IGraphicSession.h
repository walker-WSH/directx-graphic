...
public:
	...
	virtual texture_handle CreateTexture(const TextureInformation &info) = 0;
	...
	virtual void DrawTexture(shader_handle hdl, VIDEO_FILTER_TYPE flt, const std::vector<texture_handle> &) = 0;
